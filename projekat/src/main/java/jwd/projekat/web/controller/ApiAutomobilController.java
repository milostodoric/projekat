...
import jwd.projekat.support.AutomobilDTOToAutomobil;
import jwd.projekat.support.AutomobilToAutomobilDTO;
import jwd.projekat.support.NajamToNajamDTO;
...
public class ApiAutomobilController {
	...
	public ResponseEntity<AutomobilDTO> get(
		...
		Zadatak zadatak = automobilService.findOne(id);
		...
		return new ResponseEntity<>(
				toAutomobilDTO.convert(zadatak),
				HttpStatus.OK);	
	}
	...
	public ResponseEntity<AutomobilDTO> add(
		...
		Zadatak zadatak = toAutomobil.convert(novAutomobil); 
		automobilService.save(zadatak);
		
		return new ResponseEntity<>(toAutomobilDTO.convert(zadatak),
				HttpStatus.CREATED);
	}
	...
	public ResponseEntity<AutomobilDTO> edit(
		...
		Zadatak zadatak = toAutomobil.convert(izmenjen); 
		automobilService.save(zadatak);
	...
	public ResponseEntity<NajamDTO> rent(@PathVariable Long id){
		...
		Stanje n = najamService.rentACar(id);
